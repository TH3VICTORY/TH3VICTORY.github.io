--[[
العاب سورس كارمن الجديد 
--]]
local function iRambo(msg,MsgText)
...
if not redis:get(rambo..'lock_geams'..msg.chat_id_) then 
return "*🖥║((تفعيل الالعاب))\nء➖➖➖➖➖➖™\n🖲¦  •⊱{مرحباً عزيزي "..msg.TheRankCmd.."}⊰•\n🖲¦  •⊱{الالعاب بالتأكيد مفعله}⊰•\n*" 
else 
redis:del(rambo..'lock_geams'..msg.chat_id_) 
return "*🖥║((تفعيل الالعاب))\nء➖➖➖➖➖➖™\n🖲¦  •⊱{مرحباً عزيزي "..msg.TheRankCmd.."}⊰•\n🖲¦  •⊱{تم تفعيل الالعاب}⊰•\n*" 
end 
end
...
if redis:get(rambo..'lock_geams'..msg.chat_id_) then 
return "*🖥║((تعطيل الالعاب))\nء➖➖➖➖➖➖™\n🖲¦  •⊱{مرحباً عزيزي "..msg.TheRankCmd.."}⊰•\n🖲¦  •⊱{الالعاب بالتأكيد معطله}⊰•\n*" 
else
redis:set(rambo..'lock_geams'..msg.chat_id_,true)  
return "*🖥║((تعطيل الالعاب))\nء➖➖➖➖➖➖™\n🖲¦  •⊱{مرحباً عزيزي "..msg.TheRankCmd.."}⊰•\n🖲¦  •⊱{تم تعطيل الالعاب}⊰•\n*" 
end   
end
...
if not redis:get(rambo..'name_me'..msg.chat_id_) then 
return "*🙋🏼‍♂️¦((تم تفعيل اشعارات الاسم))\nء➖➖➖➖➖➖™\n📛¦  •⊱{مرحباً عزيزي "..msg.TheRankCmd.."}⊰•\n📛¦  •⊱{اشعارات الاسم بالتأكيد مفعله}⊰•\n*" 
else 
redis:del(rambo..'name_me'..msg.chat_id_) 
...
if redis:get(rambo..'name_me'..msg.chat_id_) then 
return "*🎉¦((تعطيل اشعارات الاسم))\nء➖➖➖➖➖➖™\n📛¦  •⊱{مرحباً عزيزي "..msg.TheRankCmd.."}⊰•\n📛¦  •⊱{اشعارات الاسم بالتأكيد معطله}⊰•\n*" 
else
redis:set(rambo..'name_me'..msg.chat_id_,true)  
...
redis:set(rambo..'SET:ID:USER'..msg.chat_id_,ID_USER)  
redis:setex(rambo.."SETEX:MSG"..msg.chat_id_..""..msg.sender_user_id_,500,true)  
...
local ID_USER = MsgText[2]
redis:set(rambo..'SET:ID:USER:NUM'..msg.chat_id_,ID_USER)  
redis:setex(rambo.."SETEX:NUM"..msg.chat_id_..""..msg.sender_user_id_,500,true)  
sendMsg(msg.chat_id_,msg.id_,'*📊¦ ارسل لي عدد النقاط الذي تريده*')
end
if not redis:get(rambo..'lock_geams'..msg.chat_id_) and msg.GroupActive then


if MsgText[1] == 'اسئله' or MsgText[1] == 'ختيارات' or MsgText[1] == 'بدء الاسئله' then   
redis:set(rambo.."GAME:S"..msg.chat_id_,true) 
t1 = [[
...
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'النيل') 
elseif SENDTEXT:find('14') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'14') 
elseif SENDTEXT:find('الفم') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'الفم') 
elseif SENDTEXT:find('11') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'11') 
elseif SENDTEXT:find('30') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'30') 
elseif SENDTEXT:find('بوتين') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'بوتين') 
elseif SENDTEXT:find('ستيف جوبر') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'ستيف جوبر') 
elseif SENDTEXT:find('باريس') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'باريس') 
elseif SENDTEXT:find('10') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'10') 
elseif SENDTEXT:find('النمل') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'النمل') 
elseif SENDTEXT:find('حرف الواو') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'حرف الواو') 
elseif SENDTEXT:find('الشعر') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'الشعر') 
elseif SENDTEXT:find('ابراهيم') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'ابراهيم') 
elseif SENDTEXT:find('سحاب') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'سحاب') 
elseif SENDTEXT:find('الاسم') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'الاسم') 
elseif SENDTEXT:find('ذهب') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'ذهب') 
elseif SENDTEXT:find('حرف الام') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'حرف الام') 
elseif SENDTEXT:find('العزائم') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'العزائم') 
elseif SENDTEXT:find('انسات') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'انسات') 
elseif SENDTEXT:find('المنجنيق') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'المنجنيق') 
elseif SENDTEXT:find('اسيا') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'اسيا') 
elseif SENDTEXT:find('الاسد') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'الاسد') 
elseif SENDTEXT:find('6') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'6') 
elseif SENDTEXT:find('مهر') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'مهر') 
elseif SENDTEXT:find('الدلفين') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'الدلفين') 
elseif SENDTEXT:find('اوروبا') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'اوروبا') 
elseif SENDTEXT:find('الزئبق') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'الزئبق') 
elseif SENDTEXT:find('لندن') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'لندن') 
elseif SENDTEXT:find('الانسان') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'الانسان') 
elseif SENDTEXT:find('طوكيو') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'طوكيو') 
elseif SENDTEXT:find('خديجه') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'خديجه') 
end
...
Num = math.random(1,6)
redis:set(rambo.."GAMES"..msg.chat_id_,Num) 
TEST = [[
* 🎮║((المحيبس))
ء➖➖➖➖➖➖™
🖲¦  •⊱{مرحباً عزيزي}⊰•
...
redis:setex(rambo.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 100, true)  
return false  
end
...
sendMsg(msg.chat_id_,msg.id_,TEST)   
redis:setex(rambo.."SET:t" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 100, true)  
return false  
end
...
redis:set(rambo..':Set_alii:'..msg.chat_id_,name)
...
name = katu[math.random(#katu)]
redis:set(rambo..':Set_Amthlh:'..msg.chat_id_,name)
...
name = katu[math.random(#katu)]
redis:set(rambo..':Set_Hzorh:'..msg.chat_id_,name)
...
redis:set(rambo..':NUM_SET:'..msg.chat_id_,(NUM * 3))
...
redis:set(rambo..':Set_Smile:'..msg.chat_id_,Emoji)
if tonumber(redis:get(rambo..':Set_Smile:'..msg.chat_id_)) == tonumber(redis:get(rambo..':NUM_SET:'..msg.chat_id_)) then
return '◀️┇اول من يكتب هذه العدد يفوز ؛  ››`'..(redis:get(rambo..':Set_Smile:'..msg.chat_id_))..'`'
else
return '️┇اول من يكتب هذه السمايل يفوز ››    `'..(redis:get(rambo..':Set_Smile:'..msg.chat_id_))..'`'
end
end
...
name = katu[math.random(#katu)]
redis:set(rambo..':Set_Arg:'..msg.chat_id_,name)
...
name = katu[math.random(#katu)]
redis:set(rambo..':Set_Name_Meant:'..msg.chat_id_,name)
...
local points = redis:get(rambo..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
...
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'فهمت') 
elseif SENDTEXT:find('مو جبان') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'مو جبان') 
elseif SENDTEXT:find('عدل') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'عدل') 
elseif SENDTEXT:find('نشط') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'نشط') 
elseif SENDTEXT:find('مو زين') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'مو زين') 
elseif SENDTEXT:find('مو عطشان') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'مو عطشان') 
elseif SENDTEXT:find('حاره') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'حاره') 
elseif SENDTEXT:find('مو خايف') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'مو خايف') 
elseif SENDTEXT:find('خلف') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'خلف') 
elseif SENDTEXT:find('وفي') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'وفي') 
elseif SENDTEXT:find('قزم') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'قزم') 
elseif SENDTEXT:find('لين') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'لين') 
elseif SENDTEXT:find('خشن') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'خشن') 
elseif SENDTEXT:find('عاقل') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'عاقل') 
elseif SENDTEXT:find('ذكي') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'ذكي') 
elseif SENDTEXT:find('مو ظلمه') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'مو ظلمه') 
elseif SENDTEXT:find('مو مسموح') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'مو مسموح') 
elseif SENDTEXT:find('روح') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'روح') 
end
sendMsg(msg.chat_id_,msg.id_,SENDTEXT)     
return false  
end
...
redis:set(rambo.."GAME:SE"..msg.chat_id_,true) 
K1 = [[
✖️¦12+12+4 ⚜️
]]
K2 = [[
...
redis:set(rambo.."GAME:CHERE"..msg.chat_id_,'68') 
elseif SENDTEXT:find('114') then
redis:set(rambo.."GAME:CHERE"..msg.chat_id_,'114') 
elseif SENDTEXT:find('164') then
redis:set(rambo.."GAME:CHERE"..msg.chat_id_,'164') 
elseif SENDTEXT:find('194') then
redis:set(rambo.."GAME:CHERE"..msg.chat_id_,'194') 
elseif SENDTEXT:find('28') then
redis:set(rambo.."GAME:CHERE"..msg.chat_id_,'28') 
elseif SENDTEXT:find('62') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'62') 
elseif SENDTEXT:find('109') then
redis:set(rambo.."GAME:CHERE"..msg.chat_id_,'109') 
elseif SENDTEXT:find('88') then
redis:set(rambo.."GAME:CHERE"..msg.chat_id_,'88') 
elseif SENDTEXT:find('192') then
redis:set(rambo.."GAME:CHERE"..msg.chat_id_,'192') 
elseif SENDTEXT:find('115') then
redis:set(rambo.."GAME:CHERE"..msg.chat_id_,'115') 
elseif SENDTEXT:find('124') then
redis:set(rambo.."GAME:CHERE"..msg.chat_id_,'124') 
elseif SENDTEXT:find('102') then
redis:set(rambo.."GAME:CHERE"..msg.chat_id_,'102') 
elseif SENDTEXT:find('107') then
redis:set(rambo.."GAME:CHERE"..msg.chat_id_,'107') 
elseif SENDTEXT:find('90') then
redis:set(rambo.."GAME:CHERE"..msg.chat_id_,'90') 
elseif SENDTEXT:find('182') then
redis:set(rambo.."GAME:CHERE"..msg.chat_id_,'182') 
elseif SENDTEXT:find('122') then
redis:set(rambo.."GAME:CHERE"..msg.chat_id_,'122') 
elseif SENDTEXT:find('195') then
redis:set(rambo.."GAME:CHERE"..msg.chat_id_,'195') 
elseif SENDTEXT:find('123') then
redis:set(rambo.."GAME:CHERE"..msg.chat_id_,'123') 
end
sendMsg(msg.chat_id_,msg.id_,SENDTEXT)     
return false  
end
...
redis:set(rambo.."eng:lsh"..msg.chat_id_,true) 
Ke1 = [[
✖️¦ 
...
redis:set(rambo.."eng:ken"..msg.chat_id_,'كتاب') 
elseif SENDTEXT:find('قطه') then
redis:set(rambo.."eng:ken"..msg.chat_id_,'قطه') 
elseif SENDTEXT:find('باب') then
redis:set(rambo.."eng:ken"..msg.chat_id_,'باب') 
elseif SENDTEXT:find('حاسبه') then
redis:set(rambo.."eng:ken"..msg.chat_id_,'حاسبه') 
elseif SENDTEXT:find('فاره') then
redis:set(rambo.."eng:ken"..msg.chat_id_,'فاره') 
elseif SENDTEXT:find('كنتور') then
redis:set(rambo.."GAME:CHER"..msg.chat_id_,'كنتور') 
elseif SENDTEXT:find('انترنت') then
redis:set(rambo.."eng:ken"..msg.chat_id_,'انترنت') 
elseif SENDTEXT:find('منضده') then
redis:set(rambo.."eng:ken"..msg.chat_id_,'منضده') 
elseif SENDTEXT:find('شيطان') then
redis:set(rambo.."eng:ken"..msg.chat_id_,'شيطان') 
elseif SENDTEXT:find('ضوضاء') then
redis:set(rambo.."eng:ken"..msg.chat_id_,'ضوضاء') 
elseif SENDTEXT:find('سنه') then
redis:set(rambo.."eng:ken"..msg.chat_id_,'سنه') 
elseif SENDTEXT:find('بيت') then
redis:set(rambo.."eng:ken"..msg.chat_id_,'بيت') 
elseif SENDTEXT:find('معده') then
redis:set(rambo.."eng:ken"..msg.chat_id_,'معده') 
elseif SENDTEXT:find('كاحل') then
redis:set(rambo.."eng:ken"..msg.chat_id_,'كاحل') 
elseif SENDTEXT:find('خجول') then
redis:set(rambo.."eng:ken"..msg.chat_id_,'خجول') 
elseif SENDTEXT:find('هديه') then
redis:set(rambo.."eng:ken"..msg.chat_id_,'هديه') 
elseif SENDTEXT:find('جزار') then
redis:set(rambo.."eng:ken"..msg.chat_id_,'جزار') 
elseif SENDTEXT:find('تصميم') then
redis:set(rambo.."eng:ken"..msg.chat_id_,'تصميم') 
end
sendMsg(msg.chat_id_,msg.id_,SENDTEXT)     
return false  
end
...
redis:decrby(rambo..':User_Points:'..msg.chat_id_..msg.sender_user_id_,MsgText[2])  
redis:incrby(rambo..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_,Total_Point)  
return "💰¦ تم خصم {* "..MsgText[2].." *} من نقاطك\n📮| تم زياده {* "..Total_Point.."* } من الرسائل \n📑| اصبحت رسائلك { *"..redis:get(rambo..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_).."* } رساله\n🔖"
end
end
...
redis:del(rambo..":Number_Add:"..msg.chat_id_..msg.sender_user_id_) 
redis:del(rambo..':List_Rolet:'..msg.chat_id_)  
redis:setex(rambo..":Start_Rolet:"..msg.chat_id_..msg.sender_user_id_,3600,true)  
return '*🛡║((روليت))\nء➖➖➖➖➖➖™\n⚔¦  •⊱{حسننا لنلعب}⊰•\n⚔¦  •⊱{ارسل عدد الاعبين للروليت}⊰•\n*'
end
if MsgText[1] == 'نعم' and redis:get(rambo..":Witting_StartGame:"..msg.chat_id_..msg.sender_user_id_) then
local list = redis:smembers(rambo..':List_Rolet:'..msg.chat_id_) 
if #list == 1 then 
...
redis:incrby(rambo..':User_Points:'..msg.chat_id_..data.id_,2)
end,nil)
redis:del(rambo..':List_Rolet:'..msg.chat_id_) 
redis:del(rambo..":Witting_StartGame:"..msg.chat_id_..msg.sender_user_id_)
...
local function dRambo(msg)
if msg.text and not redis:get(rambo..'lock_geams'..msg.chat_id_) then
if msg.text == redis:get(rambo..':Set_Smile:'..msg.chat_id_) then --//  الاسرع
redis:incrby(rambo..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(rambo..':Set_Smile:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*\n🎮║((الاسرع))\nء➖➖➖➖➖➖™\n🖲¦  •⊱ {اجابه صحيحه} ⊰•\n🖲¦  •⊱ { حصلت على¹نقاط } ⊰•*')end
if msg.text == redis:get(rambo..':Set_alii:'..msg.chat_id_) then -- // المختلف
redis:incrby(rambo..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(rambo..':Set_alii:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*\n🎮║((المختلف))\nء➖➖➖➖➖➖™\n🖲¦  •⊱ {اجابه صحيحه} ⊰•\n🖲¦  •⊱ { حصلت على¹نقاط } ⊰•*')end

if msg.text == redis:get(rambo..':Set_Amthlh:'..msg.chat_id_) then -- // امثله
redis:incrby(rambo..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(rambo..':Set_Amthlh:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*\n🎮║((امثله))\nء➖➖➖➖➖➖™\n🖲¦  •⊱ {اجابه صحيحه} ⊰•\n🖲¦  •⊱ { حصلت على¹نقاط } ⊰•*')end

if msg.text == redis:get(rambo..':Set_Hzorh:'..msg.chat_id_) then -- // حزوره
redis:incrby(rambo..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(rambo..':Set_Hzorh:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*\n🎮║((حزوره))\nء➖➖➖➖➖➖™\n🖲¦  •⊱ {اجابه صحيحه} ⊰•\n🖲¦  •⊱ { حصلت على¹نقاط } ⊰•*')end

if msg.text == redis:get(rambo..':Set_Arg:'..msg.chat_id_) then -- // الترتيب
redis:incrby(rambo..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(rambo..':Set_Arg:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*\n🎮║((ترتيب))\nء➖➖➖➖➖➖™\n🖲¦  •⊱ {اجابه صحيحه} ⊰•\n🖲¦  •⊱ { حصلت على¹نقاط } ⊰•*')end
if msg.text == redis:get(rambo..':Set_Name_Meant:'..msg.chat_id_) then --// المعاني
redis:incrby(rambo..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(rambo..':Set_Name_Meant:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*\n🎮║((معاني))\nء➖➖➖➖➖➖™\n🖲¦  •⊱ {اجابه صحيحه} ⊰•\n🖲¦  •⊱ { حصلت على¹نقاط } ⊰•*')end
if (msg.text == redis:get(rambo.."GAME:CHER"..msg.chat_id_)) and redis:get(rambo.."GAME:S"..msg.chat_id_) then  
sendMsg(msg.chat_id_,msg.id_,'\n🎮║((اسئله))\nء➖➖➖➖➖➖™\n🖲¦  •⊱ {اجابه صحيحه} ⊰•\n🖲¦  •⊱ { حصلت على¹مجوهىات } ⊰•')     
redis:incrby(rambo..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(rambo.."GAME:S"..msg.chat_id_)
redis:del(rambo.."GAME:CHER"..msg.chat_id_)
...
if redis:get(rambo.."GAME:S"..msg.chat_id_) then  
...
if msg.text:match("^(%d+)$") and redis:get(rambo..":Start_Rolet:"..msg.chat_id_..msg.sender_user_id_) then  --// استقبال اللعبه الدمبله
if msg.text == "1" then
Text = "*📮¦* لا استطيع بدء اللعبه بلاعب واحد فقط\n"
else
redis:set(rambo..":Number_Add:"..msg.chat_id_..msg.sender_user_id_,msg.text)  
Text = '👁‍🗨║((روليت))\nء➖➖➖➖➖➖™\n♣️¦  •⊱{تم بدء تسجيل السته}⊰•\n♣️¦  •⊱{يرجى ارسال المعرفات}⊰•\n♣️¦  •⊱{الفائز يحصل على²نقاط}⊰•\n♣️¦  •⊱{عدد الاعبين المطلوب ~*'..msg.text..'*~}⊰•\n'
end
redis:del(rambo..":Start_Rolet:"..msg.chat_id_..msg.sender_user_id_)  
return sendMsg(msg.chat_id_,msg.id_,Text)    
end
if msg.text:match('^(@[%a%d_]+)$') and redis:get(rambo..":Number_Add:"..msg.chat_id_..msg.sender_user_id_) then    --// استقبال الاسماء
if redis:sismember(rambo..':List_Rolet:'..msg.chat_id_,msg.text) then
return sendMsg(msg.chat_id_,msg.id_,'*📮¦* المعرف {['..msg.text..']} موجود اساسا' )
end
redis:sadd(rambo..':List_Rolet:'..msg.chat_id_,msg.text)
local CountAdd = redis:get(rambo..":Number_Add:"..msg.chat_id_..msg.sender_user_id_)
local CountAll = redis:scard(rambo..':List_Rolet:'..msg.chat_id_)
local CountUser = CountAdd - CountAll
if tonumber(CountAll) == tonumber(CountAdd) then 
redis:del(rambo..":Number_Add:"..msg.chat_id_..msg.sender_user_id_) 
redis:setex(rambo..":Witting_StartGame:"..msg.chat_id_..msg.sender_user_id_,1400,true)  
return sendMsg(msg.chat_id_,msg.id_,"👁‍🗨║((روليت))\nء➖➖➖➖➖➖™\n♣️¦  •⊱{تم ادخال المعرف}⊰•\n♣️¦  •⊱{م ["..msg.text.."]}⊰•\n♣️¦  •⊱{تم اكمال العدد الكلي}⊰•\n♣️¦  •⊱{هل انت مستعد}⊰•\n♣️¦  •⊱{ارسل (نعم) للبدء}⊰•\n")
end 
return sendMsg(msg.chat_id_,msg.id_,"👁‍🗨║((روليت))\nء➖➖➖➖➖➖™\n♣️¦  •⊱{تم ادخال المعرف}⊰•\n♣️¦  •⊱{م ["..msg.text.."] }⊰•\n♣️¦  •⊱{تبقى *"..CountUser.."* لاعبين ليكتمل العدد}⊰•\n♣️¦  •⊱{ارسل المعرف التالي}⊰•\n")
end
end 
if redis:get(rambo.."SETEX:MSG"..msg.chat_id_..""..msg.sender_user_id_) then 
...
redis:del(rambo.."SETEX:MSG"..msg.chat_id_..""..msg.sender_user_id_)  
return false  end 
local GET_IDUSER = redis:get(rambo..'SET:ID:USER'..msg.chat_id_)  
sendMsg(msg.chat_id_,msg.id_,"\n📬*¦ روح خالي 😉 تم اضافة له { "..msg.text.." }* رساله")
redis:incrby(rambo..'msgs:'..GET_IDUSER..':'..msg.chat_id_,msg.text)  
end
redis:del(rambo.."SETEX:MSG"..msg.chat_id_..""..msg.sender_user_id_)  
end

if redis:get(rambo.."SETEX:NUM"..msg.chat_id_..""..msg.sender_user_id_) then 
if msg.text:match("^(%d+)$") then
if tonumber(msg.text:match("^(%d+)$")) > 99999999 then
sendMsg(msg.chat_id_,msg.id_,"*📬¦ لا تستطيع اضافة اكثر من 99999999 نقاط\n*")   
redis:del(rambo.."SETEX:NUM"..msg.chat_id_..""..msg.sender_user_id_)  
return false  end 
local GET_IDUSER = redis:get(rambo..'SET:ID:USER:NUM'..msg.chat_id_)  
sendMsg(msg.chat_id_,msg.id_,"\n📬*¦ طكو طكو عمي 😻 تم اضافة له { "..msg.text.." }* نقاط")
redis:incrby(rambo..':User_Points:'..msg.chat_id_..GET_IDUSER,msg.text)  
end
redis:del(rambo.."SETEX:NUM"..msg.chat_id_..""..msg.sender_user_id_)  
end

if redis:get(rambo.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if msg.text:match("^(%d+)$") then
local NUM = msg.text:match("^(%d+)$")
if tonumber(NUM) > 6 then
sendMsg(msg.chat_id_,msg.id_,"*📬¦ عذرا لا يوجد سواء { 6 } اختيارات فقط ارسل اختيارك مره اخره*\n")   
return false  end 
local GETNUM = redis:get(rambo.."GAMES"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
redis:del(rambo.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
sendMsg(msg.chat_id_,msg.id_,'*🎮║((المحيبس))\nء➖➖➖➖➖➖™\n🖲¦  •⊱{العب وخوش تلعب}⊰•\n🖲¦  •⊱{حصلت على 3 نقاط }⊰•\n*')   
redis:incrby(rambo..':User_Points:'..msg.chat_id_..msg.sender_user_id_,3)  
...
if redis:get(rambo.."SET:t" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if msg.text:match("^(%d+)$") then
local NUM = msg.text:match("^(%d+)$")
if tonumber(NUM) > 6 then
...
local GETNUM = redis:get(rambo.."GAMES"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
redis:del(rambo.."SET:t" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
if (msg.text == redis:get(rambo.."GAME:CHER"..msg.chat_id_)) and redis:get(rambo.."GAME:S"..msg.chat_id_) then  
sendMsg(msg.chat_id_,msg.id_,'')     
redis:incrby(rambo..':User_Points:'..msg.chat_id_..msg.sender_user_id_,0)  
redis:del(rambo.."GAME:S"..msg.chat_id_)
redis:del(rambo.."GAME:CHER"..msg.chat_id_)
...
if (msg.text == redis:get(rambo.."GAME:CHERE"..msg.chat_id_)) and redis:get(rambo.."GAME:SE"..msg.chat_id_) then  
sendMsg(msg.chat_id_,msg.id_,'')     
redis:incrby(rambo..':User_Points:'..msg.chat_id_..msg.sender_user_id_,0)  
redis:del(rambo.."GAME:SE"..msg.chat_id_)
redis:del(rambo.."GAME:CHERE"..msg.chat_id_)
...
if redis:get(rambo.."GAME:SE"..msg.chat_id_) then  
local list = {'68' , '114' , ' 62' , '164' , '194' , '28' , '109' , '192' , '88' , '102' , '124' , '115' , '90' , '107' , '182' , '123' , '195' , '122'}
for k, v in pairs(list) do 
if msg.text ~= v then
sendMsg(msg.chat_id_,msg.id_,'📮¦*\n🎮║((رياضيات))\nء➖➖➖➖➖➖™\n🖲¦  •⊱ {اجابه صحيحه} ⊰•\n🖲¦  •⊱ { حصلت على⁴نقاط } ⊰•*')     
redis:incrby(rambo..':User_Points:'..msg.chat_id_..msg.sender_user_id_,4)  
redis:del(rambo.."GAME:SE"..msg.chat_id_)
redis:del(rambo.."GAME:CHERE"..msg.chat_id_)
return true   
end
...
if (msg.text == redis:get(rambo.."eng:ken"..msg.chat_id_)) and redis:get(rambo.."eng:lsh"..msg.chat_id_) then  
sendMsg(msg.chat_id_,msg.id_,'')     
redis:incrby(rambo..':User_Points:'..msg.chat_id_..msg.sender_user_id_,0)  
redis:del(rambo.."eng:lsh"..msg.chat_id_)
redis:del(rambo.."eng:ken"..msg.chat_id_)
...
if redis:get(rambo.."eng:lsh"..msg.chat_id_) then  
...
if redis:get(rambo.."chencher"..msg.sender_user_id_) then 
if redis:get(rambo.."chencher"..msg.sender_user_id_) ~= data.first_name_ then 
rsaied = '['..(redis:get(rambo.."chencher"..msg.sender_user_id_) or '')..']'
...
redis:set(rambo.."chencher"..msg.sender_user_id_, data.first_name_) 
end,nil) 
end
end
end
